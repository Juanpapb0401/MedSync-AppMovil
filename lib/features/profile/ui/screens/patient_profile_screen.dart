                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        _EstadoCard(
                          hasLinkedCaregiver: state.profile.hasLinkedCaregiver,
                        ),
                        const SizedBox(height: 16),
                        _LinkingCodeCard(code: state.profile.linkingCode),
                        const SizedBox(height: 16),
                        const _AyudaCard(),
...
class _EstadoCard extends StatelessWidget {
  final bool hasLinkedCaregiver;
  const _EstadoCard({required this.hasLinkedCaregiver});
      ...
      child: Column(
        ...
        children: [
          ...
          _StatusRow(
            ...
            badgeText: hasLinkedCaregiver ? 'Vinculado' : 'Sin vincular',
            badgeBg: hasLinkedCaregiver
                ? const Color(0xFFE7F9F5)
                : const Color(0xFFF3F4F6),
            badgeTextColor: hasLinkedCaregiver
  ...
  Widget build(BuildContext context) {
    return _Card(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _SectionLabel('MI CÓDIGO DE VINCULACIÓN'),
          ...
          child: Row(
            ...
            children: [
              _NavItem(
                ...
                label: 'Mi Rutina',
                isActive: false,
                onTap: () => Navigator.pushReplacementNamed(context, '/rutina'),
              ),
              _NavItem(
                icon: Icons.person,
                label: 'Perfil',
